...
JVB_ADAPT_CLASS((jvb)(tests)(ReadStaticDoubleAttribute)
                , (public)
                , (attributes
...
int main(int argc, char* argv[])
{
  ...
  try
  {
    e.load_class(argv[1], "jvb/tests/ReadStaticDoubleAttribute");
    assert(ReadStaticDoubleAttribute::attribute(e)() == 15.0);
  }

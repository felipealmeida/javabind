...
#ifndef JVB_DETAIL_CALL_STATIC_BYTE_METHOD_FUNCTOR_HPP
#define JVB_DETAIL_CALL_STATIC_BYTE_METHOD_FUNCTOR_HPP
...
struct call_static_byte_method_functor
{
  call_static_byte_method_functor(jclass cls, jmethodID id)
    : cls(cls), id(id) {}
  typedef byte result_type;

#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (JVB_MAX_ARGS), "jvb/detail/call_static_byte_method_functor.hpp"))
...
{
  jbyte r 
    = e.raw()->CallStaticByteMethod(cls, id

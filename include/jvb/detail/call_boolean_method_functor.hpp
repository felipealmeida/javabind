...
#ifndef JVB_DETAIL_CALL_BOOLEAN_METHOD_FUNCTOR_HPP
#define JVB_DETAIL_CALL_BOOLEAN_METHOD_FUNCTOR_HPP
...
{
  call_boolean_method_functor(jobject obj, jmethodID id)
    : obj(obj), id(id) {}
  typedef bool result_type;

#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (JVB_MAX_ARGS), "jvb/detail/call_boolean_method_functor.hpp"))

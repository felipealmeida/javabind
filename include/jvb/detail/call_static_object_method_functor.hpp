...
#ifndef JVB_DETAIL_CALL_STATIC_OBJECT_METHOD_FUNCTOR_HPP
#define JVB_DETAIL_CALL_STATIC_OBJECT_METHOD_FUNCTOR_HPP
...
template <typename T>
struct call_static_object_method_functor
{
  call_static_object_method_functor(jclass cls, jmethodID id)
    : cls(cls), id(id) {}
  typedef T result_type;

#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (JVB_MAX_ARGS), "jvb/detail/call_static_object_method_functor.hpp"))

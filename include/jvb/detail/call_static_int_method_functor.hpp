...
#ifndef JVB_DETAIL_CALL_STATIC_INT_METHOD_FUNCTOR_HPP
#define JVB_DETAIL_CALL_STATIC_INT_METHOD_FUNCTOR_HPP
...
struct call_static_int_method_functor
{
  call_static_int_method_functor(jclass cls, jmethodID id)
    : cls(cls), id(id) {}
  typedef int_ result_type;

#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (JVB_MAX_ARGS), "jvb/detail/call_static_int_method_functor.hpp"))
...
{
  jint r 
    = e.raw()->CallStaticIntMethod(cls, id

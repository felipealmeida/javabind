...
// #ifndef JVB_DETAIL_CALL_ARRAY_OBJECT_METHOD_FUNCTOR_HPP
// #define JVB_DETAIL_CALL_ARRAY_OBJECT_METHOD_FUNCTOR_HPP
...
//     : id(id) {}
//   typedef jvb::array<jvb::object> result_type;

// #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (JVB_MAX_ARGS), "jvb/detail/call_array_object_method_functor.hpp"))

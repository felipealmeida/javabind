...
template <typename T, typename Allocator, std::size_t I, std::size_t N>
struct constructor
{
  ...
  result_type operator()(environment e, Object obj) const
  {
    ...
    binding::virtual_table<N>const* virtual_table;
    ::jclass c = obj.class_(e).raw();
    {
      ...
      virtual_table = static_cast<binding::virtual_table<N>*>(p);
    }
    std::auto_ptr<binding::peer_info<T, N> >
      peer_info(new binding::peer_info<T, N>(*virtual_table, T()));
...
struct bind_method_call
{
  ...
  {
    typedef binding::method_traits<F> method_traits;
    ...
    jvb::bind_function<result_type(jvb::environment, jvb::Object)
                       , binding::method_function<I
                                                  , N, result_type, PeerClass> >
      (e, cls, FunDef::name());
                             ...
                             ) const
  {
    ...
    jvb::bind_function<void(jvb::environment, jvb::Object)
                       , binding::constructor<PeerClass, Allocator, I, N> >
      (e, cls, "<init>");
...
template <typename C, typename P, typename Allocator, typename Methods
          , typename FactoryConstructors>
Class bind_class_impl(environment e, Allocator allocator, Methods methods
                      , FactoryConstructors factory_constructors)
{
  ...
  cf.static_fields.push_back(class_files::name_descriptor_pair(binding::javabind_peer_info_field_name, "J"));
...
Class bind_class(environment e, A0 a0, A1 a1, A2 a2)
{
  ...
  return bind_class_impl<C, P>(e, get_allocator::call(params)

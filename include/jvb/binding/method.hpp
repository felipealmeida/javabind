...
<placeholder::method_value<FunctionDefinition, F> >::type>
method(ModifierExpr modifier_expr, F f)
{
  typename boost::proto::terminal<placeholder::method_value<FunctionDefinition, F> >::type r =
    { placeholder::method_value<FunctionDefinition, F>(f) };
  return r;
}

...
#ifndef JAVABIND_DETAIL_CALL_BOOLEAN_METHOD_FUNCTOR_HPP
#define JAVABIND_DETAIL_CALL_BOOLEAN_METHOD_FUNCTOR_HPP
...
jboolean operator()(O o BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(BOOST_PP_ITERATION(), A, a)) const
{
  jboolean r 

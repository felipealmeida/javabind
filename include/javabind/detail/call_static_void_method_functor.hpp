...
#ifndef JAVABIND_DETAIL_CALL_STATIC_VOID_METHOD_FUNCTOR_HPP
#define JAVABIND_DETAIL_CALL_STATIC_VOID_METHOD_FUNCTOR_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC (JAVABIND_MAX_ARGS), "javabind/detail/call_static_void_method_functor.hpp"))
